        ...
        function obj = PnPAlgorithm(pointCloud3D_,pointCloud2D_,algorithm_)
            if nargin < 3
                ...
                for i = 1:obj.numberOfPoints
                    ...
                    obj.matrixOfNoisy2DPoints(:,i) = pointCloud2D_.pointsIn2D(i).noisyCoordinatesInCameraFrame;
                    ...
                    obj.matrixOfHomogeneousNoisy2DPoints(:,i) = pointCloud2D_.pointsIn2D(i).homogeneousNoisyCoordinatesInCameraFrame;
                end
            end
        end
